...
export const questions: Question[] = [
  ...
  },
  {
    ...
    propositions: [
      ...
      "Les responsables souhaitent influer au-delà de l’organisation pour un renforcement de la cyber sécurité de leur écosystème ou de leur secteur d’activité.",
    ],
  },
  {
    ...
    propositions: [
      ...
      "Un plan d'action cyber complet et à jour fait l'objet d'un suivi régulier au niveau des responsables de l'organisation.",
  ...
  },
  {
    ...
    propositions: [
      ...
      "Des achats ponctuels de solutions cyber ont été réalisés sur les conseils du prestataire informatique de l'organisation.",
      "L’organisation dispose de plusieurs outils adaptés aux actions prioritaires identifiées dans le plan d’action.",
