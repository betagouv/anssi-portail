...
<div class="choix-filtre-besoin">
  ...
  {/if}
  <label
    class:actif={$rechercheParBesoin === BesoinCyber.ETRE_SENSIBILISE}
  >
    <img
      src="/assets/images/illustration-filtre-besoins-sensibiliser.svg"
      alt="illustration Être sensibilisé"
    />
    <input
      type="radio"
      name="filtre-besoin"
  ...
  <label
    class:actif={$rechercheParBesoin === BesoinCyber.SECURISER}
  >
    <img
      src="/assets/images/illustration-filtre-besoins-securiser.svg"
      alt="illustration Sécuriser"
    />
    <input
      type="radio"
      name="filtre-besoin"
