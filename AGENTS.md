...
- [back/](back/AGENTS.md) - Express API server, database, business logic
- [front/](front/AGENTS.md) - Jekyll static site and templates
- [front/lib-svelte/](front/lib-svelte/AGENTS.md) - Reusable Svelte components
