...
function ajoute_assets() {
    ...
    wp_enqueue_style(
        'lab-anssi-mini-test-vrai-faux-styles',
        'https://messervicescyber-web-components.cellar-c2.services.clever-cloud.com/<VERSION>/<ENV>/mini-test-vrai-faux.css',
        '',
        '1.0',
        'screen'
    );
    wp_enqueue_script(
        'lab-anssi-mini-test-vrai-faux-script',
        'https://messervicescyber-web-components.cellar-c2.services.clever-cloud.com/<VERSION>/<ENV>/mini-test-vrai-faux.iife.js',
        array(),
        null,
        true
    );
