...
function ajoute_assets() {
    ...
    wp_enqueue_style(
        'lab-anssi-mini-test-exposition-styles',
        'https://messervicescyber-web-components.cellar-c2.services.clever-cloud.com/<VERSION>/<ENV>/mini-test-exposition.css',
        '',
        '1.0',
        'screen'
    );
    wp_enqueue_script(
        'lab-anssi-mini-test-exposition-script',
        'https://messervicescyber-web-components.cellar-c2.services.clever-cloud.com/<VERSION>/<ENV>/mini-test-exposition.iife.js',
        array(),
        null,
        true
    );
