...
export const niveauxMaturite: NiveauMaturite[] = [
  {
    ...
    posture: "Le renforcement de la cybersécurité de l'organisation n'est pas une priorité.",
    pilotage:
      "La cybersécurité n'est pas ou très peu prise en compte dans la gestion des systèmes d'information de l'organisation.",
    ressourcesHumaines: "L'organisation ne dispose d'aucune ressource dédiée à la cybersécurité.",
    ...
    niveauSecurite: "L'entité est vulnérable aux menaces cyber les plus courantes.",
  },
  {
    id: 'emergent',
    label: 'Émergent',
    ...
    posture: "Les responsables de l'organisation perçoivent le sujet comme avant tout technique.",
    pilotage:
    ...
    budget: 'Des dépenses dédiées à la cybersécurité peuvent être occasionnellement autorisées.',
    adoptionSolutions: 'Une ou plusieurs solutions cyber ont pu être déployées en fonction des opportunités.',
    niveauSecurite: "L'entité est vulnérable aux menaces cyber les plus courantes.",
  },
  {
    id: 'intermediaire',
    ...
    priorite: "Structurer le plan d'action cyber et dédier une ligne budgétaire à la cybersécurité. ",
    priseEnCompteRisque:
    ...
    pilotage: "Un premier plan d'action avec des actions prioritaires à mettre en oeuvre a été établi et est suivi.",
    ressourcesHumaines:
  ...
  },
  {
    ...
    pilotage: "Un plan d'action cyber étoffé est établi et fait l’objet d’un suivi régulier.",
    ressourcesHumaines:
    ...
    budget: "Une ligne budgétaire dédiée à la cybersécurité est établie à l'échelle de l'organisation.",
    adoptionSolutions:
  ...
  },
  {
    ...
    budget: "La ligne dédiée à la cybersécurité est égale > ou = à 10% du budget informatique de l'organisation.",
    adoptionSolutions:
