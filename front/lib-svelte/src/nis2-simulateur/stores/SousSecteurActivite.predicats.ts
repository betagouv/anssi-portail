...
export const estSousSecteurListe = (sousSecteur?: SousSecteurActivite | SecteurActivite) =>
  !sousSecteur?.startsWith('autre');

export const estSousSecteurAutre = (sousSecteur?: SousSecteurActivite): sousSecteur is SousSecteurAutre =>
  !!sousSecteur?.startsWith('autre');
