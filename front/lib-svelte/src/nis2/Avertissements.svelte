...
{#if detailsReCyFOuvert}
  <Modale bind:estOuverte={detailsReCyFOuvert}>
    ...
    <p>
      Le présent outil de comparaison de référentiels est mis à disposition par l’Agence nationale de la sécurité des
      systèmes d'information (ci-après, l’Agence) à titre purement informatif et indicatif, afin de faciliter la
      compréhension par l’écosystème du référentiel NIS 2 qu’elle a élaboré. Les correspondances et les analyses
      complémentaires qu’il présente ne sauraient être interprétées comme des prescriptions à l’égard des entités qui
      souhaiteraient s’y référer et ne constituent pas une position officielle de l’Agence quant à la conformité d’une
      entité aux exigences référencées qui relève de la seule appréciation et responsabilité de l’entité qui l’utilise.
    </p>
    <p>
      Il ne constitue en aucun cas une décision d’équivalence en application de l’article 15 du projet de loi relative à
      la résilience des infrastructures critiques et au renforcement de la cybersécurité actuellement en discussion au
      Parlement.
    </p>
    <p>
      Les résultats présentés ne sauraient lier l’appréciation qui pourrait être portée par l’Agence dans l’exercice de
