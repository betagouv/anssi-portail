  ...
  <div class="contacts">
    ...
    {#if contacts.CSIRT}
      ...
      <div class="carte-contact">
        ...
        {/if}
        <p class="site-web"><a href={siteWeb} target="_blank">{siteWeb}</a></p>
        {#if adresse}
    ...
    <div class="carte-contact">
      ...
      <ul class="telephone">
        ...
        <li>
          Depuis certaines collectivités territoriales situées en Outre-mer ou
          depuis l’étranger au <a href="tel:+33 9 70 83 32 18"
            >+33 9 70 83 32 18</a
          >
        </li>
      </ul>
