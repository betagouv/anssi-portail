  ...
  describe('sur requête GET', () => {
    ...
    it('renvoie la liste des guides', async () => {
      ...
      assert.deepEqual(premierGuide.image, {
        petite:
          'https://guides.notre-cellar/zero-trust/anssi-fondamentaux-zero-trust-v1_publication-234.avif',
        grande:
      ...
      assert.deepEqual(secondGuide.image, {
        petite:
          'https://guides.notre-cellar/devsecops/anssi_essentiels_devsecops_v1-234.avif',
        grande:
