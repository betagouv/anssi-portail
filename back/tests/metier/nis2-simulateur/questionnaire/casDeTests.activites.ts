...
export const infrastructureNumerique: CasDeTest[] = [
  {
    libelleActivite: 'Fournisseur de réseaux de communications électroniques publics',
  ...
  {
    libelleActivite: 'Fournisseur de services de communications électroniques accessibles au public',
  ...
  {
    libelleActivite: "Fournisseur des services d'enregistrement de noms de domaine",
...
export const fournisseursNumeriques: CasDeTest[] = [
  ...
  {
    libelleActivite: 'Fournisseur de plateformes de services de réseaux sociaux',
...
export const autresActivites: CasDeTest[] = [
  ...
  },
  {
    ...
    libelleSecteur: 'Fabrication, production et distribution de produits chimiques',
  ...
  {
    libelleActivite: 'Autre activité',
    activite: 'autreActiviteProductionTransformationDistributionDenreesAlimentaires',
    libelleSecteur: 'Production transformation et distribution de denrées alimentaires',
  ...
  },
  {
    ...
    libelleSecteur: 'Fabrication',
    secteur: 'fabrication',
    libelleSousSecteur: 'Construction de véhicules automobiles, remorques et semi- remorques',
  ...
  },
  {
    ...
    libelleSecteur: 'Fabrication',
    secteur: 'fabrication',
    libelleSousSecteur: 'Fabrication de dispositifs médicaux et de dispositifs médicaux de diagnostic in vitro',
    sousSecteur: 'fabricationDispositifsMedicaux',
  },
  {
    libelleActivite: 'Autre activité',
    activite: 'autreActiviteFabricationProduitsInformatiquesElectroniquesOptiques',
    libelleSecteur: 'Fabrication',
    secteur: 'fabrication',
    libelleSousSecteur: 'Fabrication de produits informatiques, électroniques et optiques',
