  ...
  routeur.get(
    ...
    async (requete, reponse) => {
      const recherche = requete.query.recherche
        ? requete.query.recherche.toString()
        : '';
      const departement = requete.query.departement
        ? requete.query.departement.toString()
        : null;
      if (recherche === '') {
      ...
      if (
        departement !== null &&
        !estCodeDepartement(departement as CodeDepartement)
      ) {
