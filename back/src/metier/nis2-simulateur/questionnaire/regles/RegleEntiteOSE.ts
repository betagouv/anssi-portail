...
export class RegleEntiteOSE implements Regle {
  ...
  evalue(etat: EtatQuestionnaire) {
    return contientUnParmi(...this.valeursAcceptees)(etat.designationOperateurServicesEssentiels);
  }
  ...
  static nouvelle(texte: SpecificationTexte): RegleEntiteOSE | undefined {
    ...
    if (valeur === 'Non [OU] Ne sait pas') return new RegleEntiteOSE(['non', 'nsp']);
