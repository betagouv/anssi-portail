...
export const libellesActivites: Record<Activite, string> = {
  ...
  autreActiviteFabricationProductionDistributionProduitsChimiques: 'Autre activité',
  autreActiviteFabricationProduitsInformatiquesElectroniquesOptiques: 'Autre activité',
  ...
  autreActiviteProductionTransformationDistributionDenreesAlimentaires: 'Autre activité',
  ...
  constructionBateauxNaviresMilitaires: 'Construction de bateaux et navires militaires',
  ...
  constructionNaviresStructuresFlottantesCiviles: 'Construction de navires et de structures flottantes civiles',
  constructionVehiculeMilitaireCombat: 'Construction de véhicules militaires de combat',
  constructionVehiculesAutomobiles: 'Construction de véhicules automobiles',
  ...
  entrepriseElectriciteRemplissantFonctionFourniture: "Entreprise d'électricité remplissant une fonction de fourniture",
  entrepriseFerroviaire: "Entreprises ferroviaires, y compris les exploitants d'installation de " + 'service',
  ...
  exploitantsPlateformesNegociation: 'Exploitants de plates-formes de négociation',
  ...
  exploitantsServiceTrafficMaritime: 'Exploitants de services de trafic maritime (STM)',
  exploitantsSystemeHydrogene: 'Exploitants de systèmes de production, de stockage et de transport ' + "d'hydrogène",
  exploitantsSystemeTransportIntelligents: 'Exploitants de systèmes de transport intelligents',
  ...
  fabriquantEquipementCommunication: "Fabrication d'équipements de communication",
  ...
  fabriquantMachineEquipementNCA: 'Fabrication de machines et équipements n.c.a.',
  ...
  fabriquantMachinesAgricolesForestieres: 'Fabrication de machines agricoles et forestières',
  fabriquantMachinesFormageMetauxMachinesOutils: 'Fabrication de machines de formage des métaux et de machines-outils',
  ...
  fabriquantOrdinateursEquipementsPeripheriques: "Fabrication d'ordinateurs et d'équipements périphériques",
  fabriquantPilesAccumulateursElectriques: "Fabrication de piles et d'accumulateurs électriques",
  ...
  fabriquantProduitsElectroniquesGrandPublic: 'Fabrication de produits électroniques grand public',
  ...
  fournisseurReseauxCommunicationElectroniquesPublics: 'Fournisseur de réseaux de communications électroniques publics',
  fournisseurReseauxDiffusionContenu: 'Fournisseur de réseaux de diffusion de contenu',
  fournisseurServiceCentresDonnees: 'Fournisseur de services de centres de données',
  ...
  fournisseurServicesInformatiqueNuage: "Fournisseur de services d'informatique en nuage",
  ...
  fournisseursDistributeursEauxConsommation:
    ...
    'et biens',
  fournisseursMoteursRechercheEnLigne: 'Fournisseur de moteurs de recherche en ligne',
  fournisseursPlaceMarcheEnLigne: 'Fournisseur de places de marché en ligne',
  fournisseursPlateformesServicesReseauxSociaux: 'Fournisseur de plateformes de services de réseaux sociaux',
  fournisseurServicesEnregristrementNomDomaine: "Fournisseur des services d'enregistrement de noms de domaine",
  ...
  operateurReseauChaleurFroid: 'Opérateurs de réseaux de chaleur ou de réseaux de froid',
  organismeRecherche: 'Organismes de recherche',
  prestataireServiceConfianceQualifie: 'Prestataire de service de confiance qualifié',
  prestataireServiceConfianceNonQualifie: 'Prestataire de service de confiance non qualifié',
  prestataireSoinsSante: 'Prestataires de soins de santé',
  prestatairesServicesPostauxExpedition:
    'Prestataires de services postaux, y compris les prestataires de ' + "services d'expédition",
  ...
  registresNomsDomainesPremierNiveau: 'Registre de noms de domaines de premier niveau',
  secteurAlimentaireDistributionGrosProductionTransformationIndustrielle:
    ...
    'industrielles',
  serviceControleCirculationAerienne: 'Services du contrôle de la circulation aérienne',
  ...
  transporteursAeriensCommercial: 'Transporteurs aériens à des fins commerciales',
};
