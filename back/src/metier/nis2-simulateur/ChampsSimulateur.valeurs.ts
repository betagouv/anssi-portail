...
export const ValeursDesignationOperateurServicesEssentiels = [...ValeursOuiNon, 'nsp'] as const;
export const ValeursappartenancePaysUnionEuropeenne = ['france', 'autre', 'horsue'] as const;
