...
export type TypeEntite = 'EntiteImportante' | 'EntiteEssentielle' | 'AutreEtatMembreUE' | 'EnregistrementUniquement';
...
export const CodesResumesPointsAttention = ['NumeriqueUE', 'EtabliUE', 'RepresentantUE'];
export type ResumesPointsAttention = (typeof CodesResumesPointsAttention)[number];
...
export type PointsAttentionPrecis = (typeof CodesPrecisionsPointsAttention)[number];
